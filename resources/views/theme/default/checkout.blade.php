            ...
            <div class="col-md-7">
                ...
                <form method="POST" action="{{ route('checkout.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="email" name="email" placeholder="anda@contoh.com">
                    </div>
                    <div class="mb-3">
                        <label for="address" class="form-label">Alamat</label>
                        <input type="text" class="form-control" id="address" name="address" placeholder="Jl. Contoh 1234">
                    </div>
                    <div class="mb-3">
                    ...
                    <button class="btn w-100 mt-3" type="submit" style="background-color:#800000;color:#fff;">Pesan Sekarang</button>
                </form>
            </div>
